...
it('String', () => {
    ...
    expect(str).to.contains('de') //Verifique que existe de na frase
    expect(str).to.match(/de/) //Verifique que existe de na frase
    expect(str).to.match(/^String/) //Deve Iniciar com String
    expect(str).to.match(/teste$/) //Deve finalizar com teste
    expect(str).to.match(/.{15}/)
    expect(str).to.match(/\W+/) //Verifica que existe apenas letras
